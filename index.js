...
const croBtn = document.createElement("button");
croBtn.innerText = "cro";
croBtn.setAttribute("type", "button");
croBtn.className = "umix-toolbar-btn";
...
toolbarContainer.appendChild(croBtn);
toolbarContainer.appendChild(plusBtn);
toolbarContainer.appendChild(settingBtn);
...
inputTitle.setAttribute("placeholder", "Freedom to Ecape");
